 ...
 * The branch is decided on the *rounded* KB value, not the raw one, so a size
 * that rounds up to 1024 KB (e.g. 1048064 bytes) promotes to "1.0 MB" instead
 * of rendering as "1024 KB". */
